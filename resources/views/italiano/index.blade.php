...
<div class="container">
    <div class="row" style="margin-top: 5em">
        ...
        <div class="col-sm-6 text-justify" style="font-size:13px;">
            ...
            <p>Lo scopo di questa proposta &egrave; di riflettere rispetto ad un&rsquo;educazione basata sulla realt&agrave; stessa come punto di partenza e arrivo della conoscenza e del dialogo con le nuove dimensioni globali, basate sulla logica dell'interculturalit&agrave;.</p>
            <p>Al fine di enfatizzare la complementariet&agrave; dei fenomeni locali e globali, l'evento parte dal termine Glocalizzazione, proposto dal sociologo Roland (1992), come uno dei riferimenti interpretativi e dialogici con / tra culture, popoli e le dimensioni dei rapporti costruiti in internazionalizzazione delle conoscenze, della formazione, dei processi culturali e di comunicazione nel mondo.</p>
            <p>&nbsp;</p>
            <p>
                <h4>Obiettivo generale dell'evento:</h4>
            </p>
            <p>Sviluppo e rafforzamento di una discussione e di una riflessione su nuove strategie di scambi interculturali e di internazionalizzazione della responsabilit&agrave; sociale dell&rsquo;universit&agrave;, attraverso un approccio GloCal (dal contesto al mondo), per docenti universitari, ricercatori e studenti delle Istituzioni di educazione superiore dei contesti sociali delle citt&agrave; di Juazeiro-BA e Petrolina-PE, Brasile e delle citt&agrave; di Padova e Rovigo, Italia.</p>
        </div>
